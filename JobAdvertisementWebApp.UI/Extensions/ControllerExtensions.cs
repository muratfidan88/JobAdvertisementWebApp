...
namespace JobAdvertisementWebApp.UI.Extensions
{
    public static class ControllerExtensions
    {
        ...
        public static IActionResult ResponseRedirectToActionRoute<T>(this Controller controller, IResponse<T> response, string actionName, int id)
        {
            if (response.ResponseType == ResponseType.NotFound)
            {
                return controller.NotFound();
            ...
            return controller.RedirectToAction(actionName, new {id=id });
        }
